...
public class Attributes {
    ...
    public static class AttributeType {
        ...
        public static final AttributeType GENERIC_MAX_HEALTH = new AttributeType("generic.maxHealth","Maximum Health","MAX_HEALTH",Operation.ADD_NUMBER).register();
        public static final AttributeType GENERIC_FOLLOW_RANGE = new AttributeType("generic.followRange","Follow Range","FOLLOW_RANGE",Operation.ADD_NUMBER).register();
        public static final AttributeType GENERIC_ATTACK_DAMAGE = new AttributeType("generic.attackDamage","Attack Damage","ATTACK_DAMAGE",Operation.ADD_NUMBER).register();
        public static final AttributeType GENERIC_MOVEMENT_SPEED = new AttributeType("generic.movementSpeed","Movement Speed","MOVEMENT_SPEED",Operation.ADD_PERCENTAGE).register();
        public static final AttributeType GENERIC_KNOCKBACK_RESISTANCE = new AttributeType("generic.knockbackResistance","Knockback Resistance","KNOCKBACK_RESISTANCE",Operation.ADD_PERCENTAGE).register();
         ...
         */
        public AttributeType(String minecraftId, String name, String techName, Operation operation) {
